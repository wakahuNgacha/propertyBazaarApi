...
class Broker(models.Model):
    ...
    kra_documents = models.FileField(upload_to='kra_documents/', blank=True, null=True)
    agreement_signed = models.BooleanField(default=False)
    agreement_document = models.FileField(upload_to='agreement_documents/', blank=True, null=True)
...
class Company(models.Model):
    ...
    profile_picture = models.FileField(upload_to='company_profile_pictures/', blank=True, null=True)
